if game.PlaceId == 5956785391 then
    ...
    local spin = pj:CreateFolder("Spin")
    
    _G.wantspin = nil;
    
    spin:Button("Auto Spin",function()
        local clans = { "Kamado", "Agatsuma", "Kocho", "Tomioka", "Shinazugawa" };
...
if game.PlaceId == 6152116144 then
    ...
    --local farming = pj:CreateFolder("Farming")--
